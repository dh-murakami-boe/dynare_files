...
alpha       = 0.9;
omega       = 1.0;
// Table A calibrates lambda = 0.5, but this produces a tight/slack AS slope
// ratio of only 2:1 (= 1/(1-0.5)). Table B's empirical estimates imply a
// ratio of ~11:1 (kappa_tight/kappa_slack = 0.0736/0.0065). lambda = 0.87
// yields ~7.8:1, the maximum compatible with OccBin convergence (lambda >= 0.88 fails).
lambda_w    = 0.87;
beta_disc   = 0.99;
delta_w     = 1.0;
