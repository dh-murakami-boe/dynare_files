function [ys, params, check] = be_structural_twist_steadystate(ys, exo, M_, options_)
% BE_STRUCTURAL_TWIST_STEADYSTATE  External steady-state file for be_structural_twist.mod
%
